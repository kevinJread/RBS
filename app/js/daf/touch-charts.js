    ...
    var CalendarControl = (function (method, options) {
        ...
        function refresh() {
            ...
            if (reloadData && !options.hideDate && !dataView._survey && field.AllowQBE &&
                !(dataView._keyFields.length === 1 && dataView._keyFields[0].Name === 'sys_pk_') && (options.container.is('.ui-panel-inner') || $app.touch.settings('dates.calendar.countEvents') || field.tagged('calendar-count-events'))) {
