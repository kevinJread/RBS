...
* Copyright 2017-2019 Code On Time LLC; Licensed MIT; http://codeontime.com/license
*/
        ...
        blob: function (method, options) {
            ...
            function saveBlob(blob) {
                if (navigator.msSaveBlob)
                    ...
                    a.attr({ download: 'file.' + (blob.type || '/dat').split(/\//)[1], href: dataUrl })[0].click();
                    a.remove();
            ...
            if (row) {
                dataView._keyFields.forEach(function (pkField) {
                    ...
                    if (fieldType !== 'String' || pkField.Len === 36) {
                        ...
                        if (pkValue == null && pkField.isReadOnly())
